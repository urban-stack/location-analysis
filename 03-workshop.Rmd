...
```{r fig_3a, echo = FALSE, fig.asp=1.0, out.width='100%', fig.cap='Photograph from a May 2022 workshop with municipal and academic urban designers.'}
here("04_figures",
     "fig_3a.jpg") %>%
...
```{r fig_3b, echo = FALSE, fig.asp=1.0, out.width='100%', fig.cap='We designed a card deck with key questions, variables, and metrics to facilitate the discussion and visualization of categories or factors driving urban quality in relationship to housing development.'}
here("04_figures",
     "fig_3b.jpg") %>%
knitr::include_graphics()
```
...
```{r fig_3c, echo = FALSE, fig.asp=1.0, out.width='100%', fig.cap='Participants in remote and in-person workshops arranged these digital (right) or physical (left) cards into categories and created new cards with new metrics as needed.'}
here("04_figures",
     "fig_3c.jpg") %>%
knitr::include_graphics()
```
