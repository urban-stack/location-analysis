...
```{r fig3a, echo = FALSE, out.width='100%', fig.cap='Photograph from May 2022 workshop'}
...
```{r fig3b, echo = FALSE, out.width='100%', fig.cap='Examples from card deck with key questions for workshop'}
here("04_figures",
     "fig_3b.png") %>%
knitr::include_graphics()
```
...
```{r fig3c, echo = FALSE, out.width='100%', fig.cap='Participants in remote and in-person workshops arranged these digital (right) or physical (left) cards into categories and created new cards with new metrics as needed.'}
here("04_figures",
     "fig_3c.jpg") %>%
knitr::include_graphics()
```
