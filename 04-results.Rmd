...
```{r hull-figure, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Results of Kaiser-Guttman criterion for determining the number of factors'}
here("04_figures",
     "hull-n-factors.png") %>%
knitr::include_graphics()
```

```{r kgc-figure, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Results of Hull method for determining the number of factors'}
here("04_figures",
     "KGC-n-factors.png") %>%
knitr::include_graphics()
```
...
```{r loading-fig, echo = FALSE, fig.asp=1.9, fig.width='100%', fig.cap='Factor loadings'}
...
```{r drive-map, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Spatial variation in drivability index'}
here("04_figures",
     "drivable.png") %>%
knitr::include_graphics()
```

```{r walk-map, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Spatial variation in walkability index'}
here("04_figures",
     "walkable.png") %>%
knitr::include_graphics()
```

```{r dense-map, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Spatial variation in density index'}
here("04_figures",
     "dense.png") %>%
knitr::include_graphics()
```

```{r diverse-map, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Spatial variation in diversity index'}
here("04_figures",
     "diverse.png") %>%
knitr::include_graphics()
```

```{r amenities-map, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Spatial variation in amenity-richness index'}
here("04_figures",
     "amenities.png") %>%
knitr::include_graphics()
```
...
```{r factor-cor, echo = FALSE, fig.asp=1.0, fig.width='100%', fig.cap='Spatial variation in amenity-richness index'}
here("04_figures",
     "factor-cor.png") %>%
knitr::include_graphics()
```